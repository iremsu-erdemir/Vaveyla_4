...
import 'package:flutter_sweet_shop_app_ui/features/admin_feature/presentation/screens/admin_campaigns_screen.dart';
      ...
      body: ListView(
        ...
        children: [
          ...
          _MenuCard(
            ...
            subtitle: 'Global kampanyalar, onay/red',
            onTap: () => appPush(context, const AdminCampaignsScreen()),
          ),
